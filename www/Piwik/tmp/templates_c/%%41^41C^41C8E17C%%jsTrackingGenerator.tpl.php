<?php /* Smarty version 2.6.26, created on 2013-03-13 21:53:21
...
<p>
 ...
 <?php echo ((is_array($_tmp='CoreAdminHome_JSTrackingIntro3')) ? $this->_run_mod_handler('translate', true, $_tmp, '<a href="http://piwik.org/integrate/" target="_blank">', '</a>') : smarty_modifier_translate($_tmp, '<a href="http://piwik.org/integrate/" target="_blank">', '</a>')); ?>
	...
	<br/><br/>
	<?php echo ((is_array($_tmp='CoreAdminHome_JSTrackingIntro4')) ? $this->_run_mod_handler('translate', true, $_tmp, '<a href="#image-tracking-link">', '</a>') : smarty_modifier_translate($_tmp, '<a href="#image-tracking-link">', '</a>')); ?>
...
<div>
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "CoreHome/templates/sites_selection.tpl", 'smarty_include_vars' => array('siteName' => $this->_tpl_vars['defaultReportSiteName'],'idSite' => $this->_tpl_vars['idSite'],'showAllSitesItem' => false,'switchSiteOnSelect' => false,'siteSelectorId' => "js-tracker-website")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
<tr>
 ...
 <a href="#" class="section-toggler-link" data-section-id="javascript-advanced-options">(<?php echo ((is_array($_tmp='General_Show_js')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
)</a></th>
</tr>
<tr>
<td>
 ...
 <span class='current-site-name'><?php echo $this->_tpl_vars['defaultReportSiteName']; ?>
</span></label>
...
<h2 id="image-tracking-link"><?php echo ((is_array($_tmp='CoreAdminHome_ImageTracking')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h2>
...
<div>
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "CoreHome/templates/sites_selection.tpl", 'smarty_include_vars' => array('siteName' => $this->_tpl_vars['defaultReportSiteName'],'idSite' => $this->_tpl_vars['idSite'],'showAllSitesItem' => false,'switchSiteOnSelect' => false,'siteSelectorId' => "image-tracker-website")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
<tr>
	...
	<th><?php echo ((is_array($_tmp='Mobile_Advanced')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 <a href="#" class="section-toggler-link" data-section-id="image-tracker-advanced-options">(<?php echo ((is_array($_tmp='General_Show_js')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
)</a></th>
</tr>
<tr>
<td>
